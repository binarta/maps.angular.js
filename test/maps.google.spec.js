...
describe('bin.maps.google', function () {
    var $rootScope, $window, $log, provider, loader, loaderDeferred, applicationData;
    var apiKey = 'api-key';

    beforeEach(inject(function (_$rootScope_, _$window_, _$log_, $q, binMapsProvider, resourceLoader, viewport, applicationDataService) {
        ...
        applicationData.then.and.callFake(function (listener) {
            listener({googleMaps: {apiKey: apiKey}});
        });
    ...
    describe('with address and element', function () {
        ...
        it('Google maps script is loaded', function () {
            expect(loader.getScript).toHaveBeenCalledWith('https://maps.googleapis.com/maps/api/js?key=' + apiKey);
        });
